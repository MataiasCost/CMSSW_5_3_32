...
TH1F * h1 = new TH1F("h1","Pt_Jet" , 50,0,300);
h1 = (TH1F*)f1.Get("Pt_Jet (all)");
h1->SetFillColor(2);

TFile f2("ht_DY_M50.root");
TH1F * h2 = new TH1F("h2","Pt_Jet" , 50,0,300);
h2 = (TH1F*)f2.Get("Pt_Jet (all)");
h2->SetFillColor(7);

TFile f3("ht_DY_M10_50.root");
TH1F * h3 = new TH1F("h3","Pt_Jet" , 50,0,300);
h3 = (TH1F*)f3.Get("Pt_Jet (all)");
h3->SetFillColor(kCyan+1);

TFile f4("ht_TW.root");
TH1F * h4 = new TH1F("h4","Pt_Jet" , 50,0,300);
h4 = (TH1F*)f4.Get("Pt_Jet (all)");
h4->SetFillColor(41);

TFile f5("ht_VV.root");
TH1F * h5 = new TH1F("h5","Pt_Jet" , 50,0,300);
h5 = (TH1F*)f5.Get("Pt_Jet (all)");
h5->SetFillColor(3);

TFile f6("ht_data.root");
TH1F * h6 = new TH1F("h6","Pt_Jet" , 50,0,300);
h6 = (TH1F*)f6.Get("Pt_Jet (all)");
h6->SetFillColor(1);
...
hs->GetYaxis()->SetTitle("Entries/6 GeV");
hs->GetYaxis()->SetTitleSize(0.06);
hs->GetYaxis()->SetTitleOffset(0.8);
tx->DrawLatexNDC(0.15,0.85,Form("e#mu, #mu#mu, ee"));
c1->SaveAs("Pt_Jet (all).png");
