...
TH1F * h1 = new TH1F("h1","MassInva" , 50,0,350);
h1 = (TH1F*)f1.Get("MassInva (ee,mumu)");
h1->SetFillColor(2);

TFile f2("ht_DY_M50.root");
TH1F * h2 = new TH1F("h2","MassInva" , 50,0,350);
h2 = (TH1F*)f2.Get("MassInva (ee,mumu)");
h2->SetFillColor(7);

TFile f3("ht_DY_M10_50.root");
TH1F * h3 = new TH1F("h3","MassInva" , 50,0,350);
h3 = (TH1F*)f3.Get("MassInva (ee,mumu)");
h3->SetFillColor(kCyan+1);

TFile f4("ht_TW.root");
TH1F * h4 = new TH1F("h4","MassInva" , 50,0,350);
h4 = (TH1F*)f4.Get("MassInva (ee,mumu)");
h4->SetFillColor(41);

TFile f5("ht_VV.root");
TH1F * h5 = new TH1F("h5","MassInva" , 50,0,350);
h5 = (TH1F*)f5.Get("MassInva (ee,mumu)");
h5->SetFillColor(3);

TFile f6("ht_data.root");
TH1F * h6 = new TH1F("h6","MassInva" , 50,0,350);
h6 = (TH1F*)f6.Get("MassInva (ee,mumu)");
h6->SetFillColor(1);
...
hs->GetYaxis()->SetTitle("Entries/ 7 GeV");
hs->GetYaxis()->SetTitleSize(0.06);
hs->GetYaxis()->SetTitleOffset(0.8);
tx->DrawLatexNDC(0.15,0.85,Form("#mu#mu, ee"));
c1->SaveAs("MassInva(ee,mumu).png");
