...
TH1F * h1 = new TH1F("h1","NJetB" , 5,0,5);
h1 = (TH1F*)f1.Get("NJet (ee,mumu)");
h1->SetFillColor(2);

TFile f2("ht_DY_M50.root");
TH1F * h2 = new TH1F("h2","NJetB" , 5,0,5);
h2 = (TH1F*)f2.Get("NJet (ee,mumu)");
h2->SetFillColor(7);

TFile f3("ht_DY_M10_50.root");
TH1F * h3 = new TH1F("h3","NJetB" , 5,0,5);
h3 = (TH1F*)f3.Get("NJet (ee,mumu)");
h3->SetFillColor(kCyan+1);

TFile f4("ht_TW.root");
TH1F * h4 = new TH1F("h4","NJetB" , 5,0,5);
h4 = (TH1F*)f4.Get("NJet (ee,mumu)");
h4->SetFillColor(41);

TFile f5("ht_VV.root");
TH1F * h5 = new TH1F("h5","NJetB" , 5,0,5);
h5 = (TH1F*)f5.Get("NJet (ee,mumu)");
h5->SetFillColor(3);

TFile f6("ht_data.root");
TH1F * h6 = new TH1F("h6","NJetB" , 5,0,5);
h6 = (TH1F*)f6.Get("NJet (ee,mumu)");
h6->SetFillColor(1);
