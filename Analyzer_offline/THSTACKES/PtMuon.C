...
TH1F * h1 = new TH1F("h1","PtMuon" , 50,0,300);
h1 = (TH1F*)f1.Get("PtMuon (mumu)");
h1->SetFillColor(2);

TFile f2("ht_DY_M50.root");
TH1F * h2 = new TH1F("h2","PtMuon" , 50,0,300);
h2 = (TH1F*)f2.Get("PtMuon (mumu)");
h2->SetFillColor(7);

TFile f3("ht_DY_M10_50.root");
TH1F * h3 = new TH1F("h3","PtMuon" , 50,0,300);
h3 = (TH1F*)f3.Get("PtMuon (mumu)");
h3->SetFillColor(kCyan+1);

TFile f4("ht_TW.root");
TH1F * h4 = new TH1F("h4","PtMuon" , 50,0,300);
h4 = (TH1F*)f4.Get("PtMuon (mumu)");
h4->SetFillColor(41);

TFile f5("ht_VV.root");
TH1F * h5 = new TH1F("h5","PtMuon" , 50,0,300);
h5 = (TH1F*)f5.Get("PtMuon (mumu)");
h5->SetFillColor(3);


TFile f6("ht_data.root");
TH1F * h6 = new TH1F("h6","PtMuon" , 50,0,300);
h6 = (TH1F*)f6.Get("PtMuon (mumu)");
h6->SetFillColor(1);
