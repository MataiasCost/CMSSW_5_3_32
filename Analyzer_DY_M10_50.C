...
leg10->AddEntry(h10,"DY_M10_50 ","f");
...
leg11->AddEntry(h11,"DY_M10_50 ","f");
...
leg12->AddEntry(h12,"DY_M10_50 ","f");
leg12->SetBorderSize(0);

TFile *MyFile = new TFile("ht_DY_M10_50.root","recreate");

TFile f("DY_M10_50.root");
TTree* t;
f.GetObject("tree",t);
