...
#INPUTLIST='data/CMS_Run2011A_MET_AOD_12Oct2013-v1-all_file_index.txt'
#INPUTLIST='data/CMS_Run2011A_METBTag_AOD-v1-all_file_index.txt'
#
...
#OUTPUTDIR='ntuples-data/MET'
#OUTPUTDIR='ntuples-data/METBTag'
#
