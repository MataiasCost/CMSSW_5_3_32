...
leg12->AddEntry(h12,"WW","f");
leg12->SetBorderSize(0);

TFile *MyFile = new TFile("ht_WW.root","recreate");
...
double peso = 0.02748874770857232;
float MET,pvRho,pvZ;
